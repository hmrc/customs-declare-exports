...
@Singleton
class CustomsDeclarationsInformationConnector @Inject() (mrnStatusParser: MrnStatusParser, appConfig: AppConfig, httpClientV2: HttpClientV2)
    extends Connector with Logging {

  protected val httpClient: HttpClientV2 = httpClientV2

  def fetchMrnFullDeclaration(
    mrn: String,
    declarationVersion: Option[String]
  )(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[Elem]] =
    get[HttpResponse](
