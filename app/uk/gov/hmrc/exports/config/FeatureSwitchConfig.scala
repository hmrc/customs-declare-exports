...
import uk.gov.hmrc.exports.features.Feature.Feature
import uk.gov.hmrc.exports.features.FeatureStatus.FeatureStatus
...
class FeatureSwitchConfig @Inject() (configuration: Configuration) {
  ...
  private def feature2Key(feature: Feature): String = s"microservice.features.$feature"
