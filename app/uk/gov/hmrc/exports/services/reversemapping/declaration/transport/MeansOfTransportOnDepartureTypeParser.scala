...
@Singleton
class MeansOfTransportOnDepartureTypeParser extends DeclarationXmlParser[Option[String]] {

  override def parse(inputXml: NodeSeq)(implicit context: MappingContext): XmlParserResult[Option[String]] =
    Right(StringOption((inputXml \ Declaration \ GoodsShipment \ Consignment \ DepartureTransportMeans \ IdentificationTypeCode).text))
}
