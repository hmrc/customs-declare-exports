...
class ChangeDestinationCountryStructure extends CacheMigrationDefinition {

  private val logger = Logger(this.getClass)

  override val migrationInformation: MigrationInformation =
    MigrationInformation(id = "CEDS-2247 Change destination country structure", order = 4, author = "Patryk Rudnicki")
