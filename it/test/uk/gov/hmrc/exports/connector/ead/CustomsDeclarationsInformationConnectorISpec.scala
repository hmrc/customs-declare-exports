...
class CustomsDeclarationsInformationConnectorISpec extends IntegrationTestSpec {
  ...
  private val id = "ID"
  private val fetchMrnStatusUrl = "/mrn/" + id + "/status"
  private val fetchMrnDeclarationUrl = "/mrn/" + id + "/full"

  private val mrn = "18GB9JLC3CU1LFGVR2"
  private val mrnStatusUrl = fetchMrnStatusUrl.replace(id, mrn)
  private val mrnDeclarationUrl = fetchMrnDeclarationUrl.replace(id, mrn)
