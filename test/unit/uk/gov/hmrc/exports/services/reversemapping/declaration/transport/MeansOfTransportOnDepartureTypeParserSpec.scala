...
class MeansOfTransportOnDepartureTypeParserSpec extends UnitSpec with EitherValues {

  private val parser = new MeansOfTransportOnDepartureTypeParser

  "MeansOfTransportOnDepartureTypeParser on parse" should {
