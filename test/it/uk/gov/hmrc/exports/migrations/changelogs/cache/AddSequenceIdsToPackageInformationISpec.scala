...
import uk.gov.hmrc.exports.migrations.changelogs.cache.AddSequenceIdsToPackageInformationISpec._

class AddSequenceIdsToPackageInformationISpec extends IntegrationTestMigrationToolSpec {

  override val collectionUnderTest = "declarations"
  override val changeLog = new AddSequenceIdsToPackageInformation

  "AddSequenceIdsToPackageInformation migration" should {

    "correctly migrate declarations adding sequenceIds to 'PackageInformation' sub-documents" in {
    ...
    "not change declarations with an empty list of 'PackageInformation' sub-documents" in {
      runTest(declarationWithEmptyPackageInfo, declarationWithEmptyPackageInfo)
    }
  }
}

object AddSequenceIdsToPackageInformationISpec {
  ...
  val declarationWithEmptyPackageInfo: String =
    """{
