...
class AddNotificationSummariesToSubmissionsISpec extends IntegrationTestMigrationToolSpec {
  ...
  "AddNotificationSummariesToSubmissions" should {
    ...
    "update a Submission document" which {
      "has Action(s) which do not have yet a 'notifications' field" in {
    ...
    "always update 'latestEnhancedStatus' and 'enhancedStatusLastUpdated' from a 'SubmissionRequest' Action" in {
